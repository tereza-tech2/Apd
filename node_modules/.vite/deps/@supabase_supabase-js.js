...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => __awaiter(void 0, void 0, void 0, function* () {
      return yield (yield import("./browser-ponyfill-NCGW6O2C.js")).fetch(...args);
    });
  } else {
    _fetch = fetch;
  }
...
var resolveResponse = () => __awaiter5(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./browser-ponyfill-NCGW6O2C.js")).Response;
  }
  return Response;
});
...
var SupabaseClient = class {
  ...
  _initRealtimeClient(options) {
    var _a;
    const authHeader = (_a = options.headers) === null || _a === void 0 ? void 0 : _a.Authorization;
    const authToken = (authHeader === null || authHeader === void 0 ? void 0 : authHeader.startsWith("Bearer ")) && authHeader.split(" ")[1];
    return new RealtimeClient(this.realtimeUrl, Object.assign(Object.assign({}, options), { params: Object.assign({ apikey: authToken || this.supabaseKey }, options === null || options === void 0 ? void 0 : options.params) }));
  }
